...
use Api\Enum\RouteMethodEnum;
use Api\Enum\RouteTypeEnum;
use Api\Listener\AbstractRoutedListener;
use Api\V1\Rest;
use Api\ValueObject\ListenerValueObject;
...
final class ListenerConfigProvider
{
    ...
    {
        $finder = new Finder();
        $finder->files()->name(patterns: '*Listener.php')->in(dirs: __DIR__ . '/V1/Rest');
