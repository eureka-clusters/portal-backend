        ...
        switch ($action) {
            case 'new':
                $linkParams = [
                    ...
                    'text'  => $showOptions[$show] ?? $this->translator->translate('txt-new-transactional-email'),
                ];
                break;
            case 'view':
                $linkParams = [
            ...
            case 'edit':
                $linkParams = [
                    ...
                    'text'  => $showOptions[$show] ?? $this->translator->translate('txt-edit-transactional-email'),
                ];
                break;
        }
