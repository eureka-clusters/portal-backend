    ...
    'bjyauthorize' => [
        'guards' => [
            Route::class => [
                ...
                ['route' => 'zfcadmin/project/details/view', 'roles' => [Role::ROLE_ADMIN]],
                ['route' => 'zfcadmin/project/details/versions', 'roles' => [Role::ROLE_ADMIN]],
                ['route' => 'zfcadmin/project/details/areas', 'roles' => [Role::ROLE_ADMIN]],
                ['route' => 'zfcadmin/project/details/partners', 'roles' => [Role::ROLE_ADMIN]],
                ['route' => 'zfcadmin/project/details/evaluations', 'roles' => [Role::ROLE_ADMIN]],
            ],
        ],
    ],
];
