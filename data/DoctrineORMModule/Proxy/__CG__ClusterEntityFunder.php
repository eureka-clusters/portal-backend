 ...
 */
class Funder extends \Cluster\Entity\Funder implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Funder $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setId(int $id): \Cluster\Entity\Funder
    {
     ...
     * {@inheritDoc}
     */
    public function setUser(\Admin\Entity\User $user): \Cluster\Entity\Funder
    {
     ...
     * {@inheritDoc}
     */
    public function setCountry(\Cluster\Entity\Country $country): \Cluster\Entity\Funder
    {
     ...
     * {@inheritDoc}
     */
    public function setClusters(\Doctrine\Common\Collections\Collection $clusters): \Cluster\Entity\Funder
    {
