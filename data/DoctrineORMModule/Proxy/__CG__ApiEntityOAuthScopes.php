 ...
 */
class Scopes extends \Api\Entity\OAuth\Scopes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Api\\Entity\\OAuth\\Scopes' . "\0" . 'id', '' . "\0" . 'Api\\Entity\\OAuth\\Scopes' . "\0" . 'type', '' . "\0" . 'Api\\Entity\\OAuth\\Scopes' . "\0" . 'scope', '' . "\0" . 'Api\\Entity\\OAuth\\Scopes' . "\0" . 'clientId', '' . "\0" . 'Api\\Entity\\OAuth\\Scopes' . "\0" . 'isDefault'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Scopes $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setId(?int $id): \Api\Entity\OAuth\Scopes
    {
     ...
     * {@inheritDoc}
     */
    public function setType(string $type): \Api\Entity\OAuth\Scopes
    {
     ...
     * {@inheritDoc}
     */
    public function setScope(?string $scope): \Api\Entity\OAuth\Scopes
    {
     ...
     * {@inheritDoc}
     */
    public function setClientId(string $clientId): \Api\Entity\OAuth\Scopes
    {
     ...
     * {@inheritDoc}
     */
    public function setIsDefault(?int $isDefault): \Api\Entity\OAuth\Scopes
    {
