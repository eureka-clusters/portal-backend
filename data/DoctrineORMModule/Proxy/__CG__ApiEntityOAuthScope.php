...
class Scope extends \Api\Entity\OAuth\Scope implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Api\\Entity\\OAuth\\Scope' . "\0" . 'id', '' . "\0" . 'Api\\Entity\\OAuth\\Scope' . "\0" . 'type', '' . "\0" . 'Api\\Entity\\OAuth\\Scope' . "\0" . 'scope', '' . "\0" . 'Api\\Entity\\OAuth\\Scope' . "\0" . 'clients', '' . "\0" . 'Api\\Entity\\OAuth\\Scope' . "\0" . 'isDefault'];
        }
