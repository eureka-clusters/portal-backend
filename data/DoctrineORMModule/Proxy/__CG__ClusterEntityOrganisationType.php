...
namespace DoctrineORMModule\Proxy\__CG__\Cluster\Entity\Organisation;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Type extends \Cluster\Entity\Organisation\Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cluster\\Entity\\Organisation\\Type' . "\0" . 'id', '' . "\0" . 'Cluster\\Entity\\Organisation\\Type' . "\0" . 'type', '' . "\0" . 'Cluster\\Entity\\Organisation\\Type' . "\0" . 'organisations'];
        }
     ...
     * {@inheritDoc}
     */
    public function setId(?int $id): \Cluster\Entity\Organisation\Type
    {
     ...
     * {@inheritDoc}
     */
    public function setType(string $type): \Cluster\Entity\Organisation\Type
    {
     ...
     * {@inheritDoc}
     */
    public function setOrganisations($organisations): \Cluster\Entity\Organisation\Type
    {
