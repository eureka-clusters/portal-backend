 ...
 */
class Status extends \Cluster\Entity\Project\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cluster\\Entity\\Project\\Status' . "\0" . 'id', '' . "\0" . 'Cluster\\Entity\\Project\\Status' . "\0" . 'status', '' . "\0" . 'Cluster\\Entity\\Project\\Status' . "\0" . 'projects'];
        }
     ...
     * {@inheritDoc}
     */
    public function setId(?int $id): \Cluster\Entity\Project\Status
    {
     ...
     * {@inheritDoc}
     */
    public function setStatus(string $status): \Cluster\Entity\Project\Status
    {
