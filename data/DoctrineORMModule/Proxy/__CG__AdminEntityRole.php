...
class Role extends \Admin\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Role' . "\0" . 'description', '' . "\0" . 'Admin\\Entity\\Role' . "\0" . 'users'];
        }
    ...
    public function isUser(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isUser', []);

        return parent::isUser();
    }
     ...
     * {@inheritDoc}
     */
    public function setId(?int $id): \Admin\Entity\Role
    {
